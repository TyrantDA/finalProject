...
void FirstWheel::projection(glm::mat4 matrix)
{
	ProjectionMatrix = matrix;
}

void FirstWheel::shader(Shader* shader)
{
	myShader = shader;
}

glm::vec3 FirstWheel::getPos()
{
    return pos;
}

glm::quat FirstWheel::getRot()
{
    return rot;
}

glm::quat FirstWheel::getRo()
{
	return st;
}

void FirstWheel::update(glm::quat l, glm::quat s, glm::quat r, glm::quat ro, glm::quat so, glm::vec3 p)
{
	lean = l;
	steer = s;
	rotate = r;
